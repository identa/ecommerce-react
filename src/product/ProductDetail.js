            ...
            <div class="col-lg-6">
              <div class="row m-sm-0">
                <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0">
                  <div
                    class="owl-thumbs d-flex flex-row flex-sm-column"
                    data-slider-id="1"
                  >
                    ...
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0" onClick={onItemClick}>
                      <img
                        class="w-100"
                ...
                <div class="col-sm-10 order-1 order-sm-2">
                  <Slider class="owl-carousel product-slider" {...settings} ref={slideRef}>
                    <a
                      class="d-block"
